...
def checkstate(last):
    ...
    if (currentTrack != None):
        ...
        RPC.update(state="Status", details="DETAILS HERE", large_image="https://img-07.stickers.cloud/packs/67665596-9ef6-4037-a654-f0f5170912cc/webp/21d03efa-71f9-4dd2-b1b2-87d7d9737fc6.webp", small_image="NAME OF SMALL IMAGE HERE", large_text="LARGE IMAGE TEXT HERE", start=start_time)  # Set the presence
...
print("Discord Apple Music Presence by hihison V1.01")
print("https://siu4.me")
print("==========================================")
...
try:
    ...
    client_id = '00000000000' #Put your client ID here
